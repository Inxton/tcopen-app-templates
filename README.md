...
~~~Powershell
dotnet tool install TcOpen.tco --global --version 0.3.0-release.167
~~~

## Updating to specific version

~~~Powershell
dotnet tool update TcOpen.tco --global --version 0.3.0-release.167
~~~
...
~~~Powershell
tco --project-name MyNewProject --template-name mts-s-template --source repository --release 0.3.0-release.167
~~~
### Important!  
